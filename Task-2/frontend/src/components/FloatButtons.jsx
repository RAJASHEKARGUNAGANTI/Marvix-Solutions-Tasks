const FloatButtons = () => {
    return (
      <div className=" fixed bottom-10 right-16 left-16 z-50 ">
        <button>
          <svg className="h-16 w-16 absolute bottom-4 left-4 p-3 z-10 text-black bg-gradient-to-r from-blue-300 to-green-300 rounded-full" viewBox="0 0 24 24" fill="black" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
          </svg>
        </button>
        <p className=" absolute bottom-6 left-24 bg-white p-3 rounded-full ">Chat with us 👋</p>
        <button>
